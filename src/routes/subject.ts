...
import { delete_Subject,get_Subject,get_Subjects,get_Users_Subject,matriculate_Subject,post_Subject, update_Subject } from "../controllers/subject";
...
router.get("/list/Users", get_Users_Subject);
